		...
		<div className="col-md-4 grid-margin stretch-card">
                ...
                {isLoading ? <h3 className="text-center">Loading</h3> :
					...
					<div className="form-group">
                      ...
                      <select className="form-control form-control-lg text-white" id="location" name="location">
					...
					<div className="form-group">
                      ...
                      <select className="form-control form-control-lg text-white" id="status" name="status">
					  <option>true</option>
					  <option>false</option>
                      </select>
                    </div>
			  ...
			  <div className="col-md-4 grid-margin stretch-card">
                <div className="card">
                  <div className="card-body">
					...
					<hr/>
					<p className="text-center text-white">Heyy there, thank you for downloading the Corona Theme</p>
					<p className="text-center text-white">Join my Discord Server for more Themes like this</p>
					<p className="text-center text-white"><a href="https://discord.gg/McFr2jwNSE">https://discord.gg/McFr2jwNSE</a></p>
					<p className="text-center text-white">Hope you will like it :3</p>
                  </div>
                </div>
              </div>
		</>
