              ...
              <div className="card">
                <div className="card-body">
                 ...
                 <p className="text-left"><b>Loading</b></p>
					  :  keys.map((key) =>
                        <tr>
                          <td className="text-white"> {key.key} </td>
                          <td className="text-white"> {key.description.length > 15 ? key.description.slice(0, 12) + '...' : key.description} </td>
                          <td className="text-white"> {key.last_used} </td>
                          <td className="text-white"> {key.created} </td>
                          <td>
