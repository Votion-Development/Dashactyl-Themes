                ...
                <div className="card-body">
                  ...
                  <form onSubmit={addPackageForm} id="addPackageForm">
					...
					<div className="form-group">
                      ...
                      <input type="text" className="form-control text-white" name="price" id="price" placeholder=" " required/>
                    </div>
                    <div className="form-group">
                      <label htmlFor="renewal_enabled">Renewal Enabled</label>
                      <select className="form-control text-white" id="renewal_enabled" name="renewal_enabled">
					  <option>true</option>
					  <option>false</option>
                      </select>
                    </div>
					<div className="form-group">
                      ...
                      <input type="text" className="form-control text-white" name="renewal_time" id="renewal_time" placeholder=" " required/>
                    </div>
					<div className="form-group">
                      <label htmlFor="renewal_price">Renewal Price</label>
                      <input type="text" className="form-control text-white" name="renewal_price" id="renewal_price" placeholder=" " required/>
                    </div>
