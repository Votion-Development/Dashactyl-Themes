                ...
                <div className="card">
                  <div className="card-body">
                    ...
                    <div className="form-group">
                      ...
                      <input type="text" className="form-control text-white" name="location_name" id="location_name" placeholder=" " required/>
                    </div>
					<div className="form-group">
                      <label htmlFor="location_id">ID</label>
                      <input type="text" className="form-control text-white" name="location_id" id="location_id" placeholder=" " required/>
                    </div>
					<div className="form-group">
                      <label htmlFor="location_enabled">Enabled</label>
                      <select className="form-control form-control-lg text-white" id="location_enabled" name="location_enabled">
                        <option>true</option>
                        <option>false</option>
                      </select>
                    </div>
