			...
			<div className="col-xl-12">
                    <div className="card">
                                <div
                                    ...
                                    <h6 className="m-0 font-weight-bold text-primary">Purchase Additional Resources</h6>
                                </div>
				   ...
				   :
                            <form>
                                ...
                                <button onClick={purchaseRam} type="button" className="btn btn-primary">Buy</button>
                            </form> }
                            <hr/>
							{isLoading ? <p className="text-center"><b>Loading</b></p>
				   :
                            <form>
                                ...
                                <button onClick={purchaseDisk} type="button" className="btn btn-primary">Buy</button>
                            </form> }
                            <hr/>
							{isLoading ? <p className="text-center"><b>Loading</b></p>
				   :
                            <form>
                                ...
                                <button onClick={purchaseCpu} type="button" className="btn btn-primary">Buy</button>
                            </form> }
                        </div>
                    </div>
                </div>
